...
export const ContactItem = ({
    ...
    const { contactActionClickHandler } = useContext(ContactContext);
    return (
        <tr>
            <td>
                {/* <img src={imageUrl ? imageUrl : "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png"}
                    alt="Peter's profile" className="image" /> */}
                <img src={imageUrl || blankImg} alt={`${firstName}'s profile`} className="image" />
            </td>
            <td>{firstName}</td>
            <td>{lastName}</td>
            <td>{email}</td>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => contactActionClickHandler(objectId, ContactsAction.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => contactActionClickHandler(objectId, ContactsAction.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => contactActionClickHandler(objectId, ContactsAction.Details)}>
