    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onActionClick(objectId, ContactsAction.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onActionClick(objectId, ContactsAction.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onActionClick(objectId, ContactsAction.Details)}>
